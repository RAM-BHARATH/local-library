...
exports.bookinstance_delete_get = function(req, res, next) {
    async.parallel({
        ...
        res.render('bookinstance_delete', { title:'Delete Book Instance', book_instance: results.book_instance, book: results.book })
    });
};
    ...
    (req, res, next)=>{
        ...
        if(!errors.isEmpty()){
            async.parallel({
                ...
                if (err) { return next(err); }
                res.render('bookinstance_form', { title:'Update Book Instance', bookinstance: bookinstance, book_list:results.books })
            })
        }
        else{
